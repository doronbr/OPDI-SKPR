# tools/bootstrap_repo.ps1
# Bootstraps an ESP-IDF v5.5 project + CI + docs placeholders (PowerShell version)
...
Write-Text "sdkconfig.defaults" @"
CONFIG_HTTPD_MAX_REQ_HDR_LEN=1024
CONFIG_HTTPD_WS_SUPPORT=y
CONFIG_LWIP_LOCAL_HOSTNAME="opdi-skpr"
"@

Write-Text "partitions.csv" @"
...
Write-Text ".github/workflows/build.yml" @"
name: build
on:
  push:
  pull_request:
...
Write-Host "1) git add -A; git commit -m 'chore: bootstrap ESP-IDF project + CI'"
Write-Host "2) git push origin HEAD"
